<template>
  <div class="cardbox p-col-12 p-md-6 p-lg-4">
    <Card class="p-p-2">
      <template #title>Most wins opponents</template>
      <template #content>
  ...
  computed: {
    chartData(): Object {
      return {
        ...
        data: {
          labels: this.all_player_stats.mostWon.mostPlayedList.slice(0, 10),
          datasets: [
            {
              label: "Matches",
              data: this.all_player_stats.mostWon.mostPlayedCount.slice(0, 10),
              backgroundColor: Array(10).fill("#1f65cf"),
              stack: "Stack 0",
            },
            {
              label: "Lost",
              data: this.all_player_stats.mostWon.mostPlayedLost.slice(0, 10),
              backgroundColor: Array(10).fill("#c91f1c"),
              stack: "Stack 1",
            },
            {
              label: "Won",
              data: this.all_player_stats.mostWon.mostPlayedWon.slice(0, 10),
