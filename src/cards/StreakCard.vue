  ...
  computed: {
    ...
    lossMessage(): String {
      ...
      if (this.all_match_stats.lossStreak.netElo != 0) {
        message += ` In these games, you went from <b>${this.all_match_stats.lossStreak.startElo}</b> to <b>${this.all_match_stats.lossStreak.endElo}</b>, losing a total of <b>${this.all_match_stats.lossStreak.netElo}</b> ELO`;
      }
      return message;
    },
  },
